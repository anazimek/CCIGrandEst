...
class AdsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'ads_type_2' => ['type' => 'foreign', 'columns' => ['type_id'], 'references' => ['type_ads', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
    ...
    public $records = [
        [
            ...
            'latitude' => 1,
            'longitude' => 1,
            'created' => '2016-07-26 12:08:43',
            'modified' => '2016-07-26 12:08:43'
        ],
    ];
}
