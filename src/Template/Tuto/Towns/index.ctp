    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th><?= $this->Paginator->sort('town_zip_code') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $town->has('area') ? $this->Html->link($town->area->id, ['controller' => 'Areas', 'action' => 'view', $town->area->id]) : '' ?></td>
                <td><?= h($town->town_name) ?></td>
                <td><?= h($town->town_zip_code) ?></td>
